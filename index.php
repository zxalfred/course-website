    ...
    <div class="loginBody">
    	<form action="pages/doLogin.php" method="post">
            ...
            <div id="verifyDiv">
                ...
                <a href="pages/login.php" title="点击更换"><img src="pages/getVerify.php" alt="" class="verifyImg"></a>
            </div>
...
<div id="head">
    ...
    <div id="navDiv">
        ...
        <ul class="nav">
            ...
            <li><a href="javascript:alert('对不起，请先登录！');$('#topBtn').click();">作业提交</a></li>
            <li><a href="javascript:alert('对不起，请先登录！');$('#topBtn').click();">提交情况</a></li>
            <li><a href="javascript:alert('对不起，请先登录！');$('#topBtn').click();">在线测试</a></li>
        </ul>
    </div>
</div>
<div id="main">
